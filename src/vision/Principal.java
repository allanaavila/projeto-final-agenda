...
public class Principal {
    ...
    private void alterarContato() {
        ...
        try {
            Contato contatoAntigo = controladorAgenda.alterarContato(telefoneAntigo, contatoAtualizado);
            System.out.println("Contato atualizado com sucesso!");

            System.out.println("\nAlterações realizadas:");
            System.out.println("\n╔═════════════════════════════════════════════════════════╗\n");

            System.out.printf(" Nome: %s -- para --> %s\n", contatoAntigo.getNome() + " " + contatoAntigo.getSobrenome(), contatoAtualizado.getNome() + " " + contatoAtualizado.getSobrenome());
            System.out.printf(" Telefone: %s -- para --> %s\n", contatoAntigo.getTelefone(), contatoAtualizado.getTelefone());
            System.out.printf(" E-mail: %s -- para --> %s\n", contatoAntigo.getEmail(), contatoAtualizado.getEmail());
            System.out.println("╚═════════════════════════════════════════════════════════╝");
    ...
    private void excluirContato() {
        ...
        try {
            Contato contatoRemovido = controladorAgenda.removerContato(telefone);
            System.out.println("Contato excluído com sucesso!");
            System.out.println(contatoRemovido.toString());
        } catch (ContatoNaoEncontradoException e) {
            Util.erro(e.getMessage());
        } catch (Exception e) {
            Util.erro("Erro inesperado: " + e.getMessage());
